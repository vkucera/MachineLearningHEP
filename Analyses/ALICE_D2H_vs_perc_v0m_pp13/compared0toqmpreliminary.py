...
def compared0toqmpreliminary():
    ...
    filembqm = TFile.Open(
        "../ALICE_D2H_vs_mult_pp13/data/PreliminaryQM19/finalcrossD0ppMBvspt_ntrklmult0.root",
        "READ",
    )
    fileour = TFile.Open(
        "/data/DerivedResults/D0kAnywithJets/vAN-20200304_ROOT6-1/pp_data/resultsMBvspt_perc_v0m/finalcrossD0ppMBvspt_perc_v0mmult0.root",
        "READ",
    )
