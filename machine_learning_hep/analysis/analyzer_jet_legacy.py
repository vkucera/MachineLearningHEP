...
class AnalyzerJet(Analyzer):
    ...
    def __init__(self, datap, case, typean, period):
        ...
        self.niterunfoldingregup = datap["analysis"][self.typean].get(
            "niterunfoldingregup", None
        )
        self.niterunfoldingregdown = datap["analysis"][self.typean].get(
            "niterunfoldingregdown", None
        )
        ...
        self.powheg_nonprompt_variations = datap["analysis"][self.typean].get(
            "powheg_nonprompt_variations", None
        )
        self.powheg_nonprompt_variations_path = datap["analysis"][self.typean].get(
            "powheg_nonprompt_variations_path", None
        )
        ...
        self.systematic_categories = datap["analysis"][self.typean].get(
            "systematic_categories", None
        )
        self.systematic_variations = datap["analysis"][self.typean].get(
            "systematic_variations", None
        )
        self.systematic_correlation = datap["analysis"][self.typean].get(
            "systematic_correlation", None
        )
        self.systematic_rms = datap["analysis"][self.typean].get("systematic_rms", None)
        self.systematic_symmetrise = datap["analysis"][self.typean].get(
            "systematic_symmetrise", None
        )
        self.systematic_rms_both_sides = datap["analysis"][self.typean].get(
            "systematic_rms_both_sides", None
        )
    ...
    def fit(self):
        ...
        for ipt in range(self.p_nptfinbins):
            ...
            for ibin2 in range(self.p_nbin2_reco):
                ...
                p_fitted_result = TPad(
                    "p_fitted_result" + suffix,
                    "p_fitted_result" + suffix,
                    0.0,
                    0.001,
                    1.0,
                ...
                latex2 = TLatex(
                    0.2,
                    0.8,
                    "%.2f < #it{p}_{T, Lc} < %.2f GeV/#it{c}"
                    % (self.lpt_finbinmin[ipt], self.lpt_finbinmax[ipt]),
                )
                draw_latex(latex2)
                c_fitted_result.SaveAs(
                    "%s/fitted_result_%s.eps" % (self.d_resultsallpdata, suffix)
                )
    ...
    def feeddown(self):
        ...
        fileouts = TFile.Open(
            "%s/feeddown%s%s.root" % (self.d_resultsallpdata, self.case, self.typean),
            "recreate",
        )
        ...
        sideband_input_data_file = TFile.Open(
            "%s/sideband_sub%s%s.root"
        ...
        pgen_eff = TPad(
            "pgen_eff_nonprompt ",
            "gen efficiency applied to feedown",
            0.0,
            0.0,
            1.0,
            1.0,
        ...
        preco_eff = TPad(
            "preco_eff_nonprompt ",
            "reco efficiency applied to feedown",
            0.0,
            0.0,
            1.0,
            1.0,
        ...
        for ibin2 in range(self.p_nbin2_reco):
            ...
            draw_latex(latex)
            cz_genvsreco.SaveAs(
                "%s/cz_genvsreco_nonprompt_%s.eps" % (self.d_resultsallpdata, suffix)
            )
        ...
        for ibinshape in range(self.p_nbinshape_reco):
            ...
            pjetpt_genvsreco = TPad(
                "pjetpt_genvsreco_nonprompt" + suffix,
                "response matrix 2D projection",
                0.0,
                0.001,
                1.0,
            ...
            cjetpt_genvsreco.SaveAs(
                "%s/cjetpt_genvsreco_nonprompt_%s.eps"
        ...
        pz_genvsreco = TPad(
            "pz_genvsreco_full_nonprompt" + suffix,
            "response matrix 2D projection",
            0.0,
            0.001,
            1.0,
        ...
        cz_genvsreco.SaveAs(
            "%s/cz_genvsreco_full_nonprompt.eps" % (self.d_resultsallpdata)
        )
        ...
        pjetpt_genvsreco = TPad(
            "pjetpt_genvsreco_full_nonprompt" + suffix,
            "response matrix 2D projection",
            0.0,
            0.001,
            1.0,
        ...
        cjetpt_genvsreco.SaveAs(
            "%s/cjetpt_genvsreco_full_nonprompt.eps" % (self.d_resultsallpdata)
        )
        ...
        for ibin2 in range(self.p_nbin2_gen):
            ...
            ceff.SetCanvasSize(1900, 1500)
            ceff.SetWindowSize(500, 500)
            leg_eff = TLegend(0.65, 0.55, 0.8, 0.7, "")
            ...
            heff_pr_list[ibin2].GetYaxis().SetRangeUser(
                0.5
                * min(
                    heff_pr_list[ibin2].GetMinimum(), heff_fd_list[ibin2].GetMinimum()
                ),
                1.1
                * max(
                    heff_pr_list[ibin2].GetMaximum(), heff_fd_list[ibin2].GetMaximum()
                ),
            )
            heff_pr_list[ibin2].SetXTitle(
                "#it{p}_{T, #Lambda_{c}^{#plus}} (GeV/#it{c})"
            )
            ...
            latex3 = TLatex(
                0.52,
                0.35,
                "#Lambda_{c}^{#plus} #rightarrow p K_{S}^{0} (and charge conj.)",
            )
            draw_latex(latex3)
            ...
            latex5 = TLatex(
                0.52,
                0.25,
                "%.0f < #it{p}_{T, jet}^{ch} < %.0f GeV/#it{c}"
                % (self.lvar2_binmin_reco[ibin2], self.lvar2_binmax_reco[ibin2]),
            )
            draw_latex(latex5)
        ...
        leg_jetpt_fracdiff = TLegend(0.65, 0.5, 0.8, 0.8, "#it{p}_{T, jet}^{gen}")
        ...
        for ibin2 in range(self.p_nbin2_gen):
            ...
            if ibin2 == 0:
                ...
                hjetpt_fracdiff_list[ibin2].GetYaxis().SetRangeUser(
                    0.001, hjetpt_fracdiff_list[ibin2].GetMaximum() * 3
                )
            hjetpt_fracdiff_list[ibin2].Draw("same")
        leg_jetpt_fracdiff.Draw("same")
        cjetpt_fracdiff.SaveAs(
            "%s/cjetpt_fracdiff_nonprompt.eps" % (self.d_resultsallpdata)
        )
        ...
        pz_fracdiff = TPad(
            "pz_fracdiff",
            "non-prompt z response fractional differences",
            0.0,
            0.001,
            1.0,
            1.0,
        ...
        leg_z_fracdiff = TLegend(0.2, 0.5, 0.4, 0.85, "z")
        ...
        for ibinshape in range(self.p_nbinshape_gen):
            ...
            if ibin2 == 0:
                ...
                hz_fracdiff_list[ibin2].GetYaxis().SetRangeUser(
                    0.001, hz_fracdiff_list[ibin2].GetMaximum() * 3
                )
        ...
        for ibin2 in range(self.p_nbin2_reco):
            ...
            draw_latex(latex)
            c_fd_fold.SaveAs(
                "%s/cfolded_Powheg_%s.eps" % (self.d_resultsallpdata, suffix)
            )
        fileouts.cd()
        ...
        for ibin2 in range(self.p_nbin2_reco):
            ...
            pfeeddown = TPad(
                "pfeeddown" + suffix, "cfeeddown" + suffix, 0.0, 0.001, 1.0, 1.0
            )
            setup_pad(pfeeddown)
            if ibin2 is not 2:
                cfeeddown.SetLogy()
            ...
            leg_feeddown.AddEntry(
                sideband_input_data_subtracted_z[ibin2], "subtracted (prompt)", "LEP"
            )
            ...
            draw_latex(latex)
            cfeeddown.SaveAs(
                "%s/cfeeddown_subtraction_%s.eps" % (self.d_resultsallpdata, suffix)
            )
            ...
            pfeeddown_fraction = TPad(
                "pfeeddown_fraction" + suffix,
            ...
            cfeeddown_fraction.SaveAs(
                "%s/cfeeddown_fraction_%s.eps" % (self.d_resultsallpdata, suffix)
            )

        cfeeddown_output = TCanvas("cfeeddown_output", "cfeeddown_output")
        pfeeddown_output = TPad(
            "pfeeddown_output", "pfeeddown_output", 0.0, 0.001, 1.0, 1.0
        )
    ...
    def side_band_sub(self):
        ...
        # Simple fitter START
        func_filename = self.make_file_path(
            self.d_resultsallpdata,
            self.yields_filename,
            "root",
            None,
        ...
        for imult in range(self.p_nbin2_reco):
            ...
            for ipt in range(self.p_nptfinbins):
                ...
                hzsub.GetYaxis().SetRangeUser(
                    hzsub.GetMinimum(), hzsub.GetMaximum() * 1.2
                )
                ...
                draw_latex(latex2)
                csubz.SaveAs(
                    "%s/side_band_subtracted%s%s_%s.eps"
                ...
                hzsig.GetYaxis().SetRangeUser(
                    hz_min / (1.0 if hz_ratio == 0 else pow(hz_ratio, hz_margin_min)),
                    hz_max * pow(hz_ratio, hz_margin_max),
                )
                hzsig.GetXaxis().SetRangeUser(
                    self.lvarshape_binmin_reco[0] + 0.01,
                ...
                latex = TLatex(
                    0.42, 0.85, "ALICE Preliminary, pp, #sqrt{#it{s}} = 13 TeV"
                )
                draw_latex(latex)
                latex1 = TLatex(
                    0.42,
                    0.8,
                    "charged jets, anti-#it{k}_{T}, #it{R} = 0.4, #left|#it{#eta}_{jet}#right| < 0.5",
                )
                draw_latex(latex1)
                latex2 = TLatex(
                    0.42,
                ...
                latex3 = TLatex(
                    0.42,
                    0.7,
                    "with #Lambda_{c}^{#plus} (& cc), %.0f < #it{p}_{T, #Lambda_{c}^{#plus}} < %.0f GeV/#it{c}"
                    % (self.lpt_finbinmin[ipt], self.lpt_finbinmax[ipt]),
                )
                draw_latex(latex3)
            ...
            draw_latex(latex)
            cz.SaveAs(
                "%s/efficiencycorrected_fullsub%s%s_%s_%.2f_%.2f.eps"
                % (
                    self.d_resultsallpdata,
                    self.case,
                    self.typean,
            ...
            for zbins in range(nzbin_reco):
                hzvsjetpt.SetBinContent(
                    zbins + 1, imult + 1, hz.GetBinContent(zbins + 1)
                )
    ...
    def unfolding(self):
        ...
        fileouts = TFile.Open(
            "%s/unfolding_results%s%s.root"
            % (self.d_resultsallpdata, self.case, self.typean),
            "recreate",
        )

        unfolding_input_data_file = TFile.Open(
            "%s/feeddown%s%s.root" % (self.d_resultsallpdata, self.case, self.typean)
        )
        ...
        for i_powheg in range(len(self.powheg_prompt_variations)):
            ...
            input_powheg_sys.append(
                input_powheg_file_sys[i_powheg].Get("fh2_powheg_prompt")
            )
            input_powheg_xsection_sys.append(
                input_powheg_file_sys[i_powheg].Get("fh2_powheg_prompt_xsection")
            )
        input_powheg_z = []
        ...
        for ibin2 in range(self.p_nbin2_reco):
            ...
            mc_reco_matched_z[ibin2].Scale(
                1.0 / mc_reco_matched_z[ibin2].Integral(1, -1)
            )
            ...
            p_mc_reco_gen_matched_z_ratio = TPad(
                "p_mc_reco_gen_matched_z_ratio" + suffix,
                "c_mc_reco_gen_matched_z_ratio" + suffix,
                0.0,
                0.001,
                1.0,
                1.0,
            ...
            c_mc_reco_gen_matched_z_ratio.SaveAs(
                "%s/mc_reco_gen_matched_z_ratio_%s.eps"
                % (self.d_resultsallpdata, suffix)
            )
            ...
            p_mc_reco_gen_matched_z = TPad(
                "p_mc_reco_gen_matched_z" + suffix,
                "Reco vs Gen" + suffix,
                0.0,
                0.001,
                1.0,
            ...
            leg_mc_reco_gen_matched_z = TLegend(0.75, 0.7, 0.9, 0.85, "")
            ...
            mc_reco_matched_z[ibin2].GetYaxis().SetRangeUser(
                0.0, mc_reco_matched_z[ibin2].GetMaximum() * 1.5
            )
            ...
            c_mc_reco_gen_matched_z.SaveAs(
                "%s/mc_reco_gen_matched_z_%s.eps" % (self.d_resultsallpdata, suffix)
            )
            ...
            pz_genvsreco = TPad(
                "pz_genvsreco" + suffix,
                "response matrix 2D projection" + suffix,
                0.0,
                0.001,
                1.0,
                1.0,
            ...
            draw_latex(latex)
            cz_genvsreco.SaveAs(
                "%s/cz_genvsreco_%s.eps" % (self.d_resultsallpdata, suffix)
            )
        ...
        for ibinshape in range(self.p_nbinshape_reco):
            ...
            draw_latex(latex)
            cjetpt_genvsreco.SaveAs(
                "%s/cjetpt_genvsreco_%s.eps" % (self.d_resultsallpdata, suffix)
            )
        ...
        cz_genvsreco_full = TCanvas(
            "cz_genvsreco_full", "response matrix 2D projection"
        )
        pz_genvsreco_full = TPad(
            "pz_genvsreco_full", "response matrix 2D projection", 0.0, 0.001, 1.0, 1.0
        )
        ...
        pjetpt_genvsreco_full = TPad(
            "pjetpt_genvsreco_full",
            "response matrix 2D projection",
            0.0,
            0.001,
            1.0,
        ...
        cjetpt_genvsreco_full.SaveAs(
            "%s/cjetpt_genvsreco_full.eps" % (self.d_resultsallpdata)
        )
        ...
        for ibin2 in range(self.p_nbin2_gen):
            ...
            pkinematic_eff = TPad(
                "pkinematic_eff" + suffix,
                "Kinematic Eff" + suffix,
                0.0,
                0.001,
                1.0,
                1.0,
            ...
            ckinematic_eff.SaveAs(
                "%s/cgen_kineeff_%s.eps" % (self.d_resultsallpdata, suffix)
            )
            ...
            input_mc_gen_z[ibin2].Scale(
                ...
                / input_mc_gen_z[ibin2].Integral(
                    input_mc_gen_z[ibin2].FindBin(self.lvarshape_binmin_reco[0]),
        ...
        pkinematic_eff_jetpt = TPad(
            "pkinematic_eff_jetpt", "Kinematic Eff_jetpt", 0.0, 0.001, 1.0, 1.0
        )
        ...
        kinematic_eff_jetpt.GetXaxis().SetRangeUser(
            self.lvar2_binmin_reco[0] + 0.01, self.lvar2_binmax_reco[-1] - 0.001
        )
        ...
        ckinematic_eff_jetpt.SaveAs(
            "%s/cgen_kineeff_jetpt.eps" % (self.d_resultsallpdata)
        )
        ...
        pjetpt_fracdiff = TPad(
            "pjetpt_fracdiff",
            "prompt jetpt response fractional differences",
            0.0,
            0.001,
            1.0,
            1.0,
        ...
        cjetpt_fracdiff.SetCanvasSize(1900, 1500)
        cjetpt_fracdiff.SetWindowSize(500, 500)
        leg_jetpt_fracdiff = TLegend(0.65, 0.6, 0.8, 0.8, "#it{p}_{T, jet} GeV/#it{c}")
        setup_legend(leg_jetpt_fracdiff)
        for ibin2 in range(self.p_nbin2_gen):
            setup_histogram(hjetpt_fracdiff_list[ibin2], ibin2 + 1)
            leg_jetpt_fracdiff.AddEntry(
            ...
            if ibin2 == 0:
                hjetpt_fracdiff_list[ibin2].GetYaxis().SetRangeUser(
                    0.001, hjetpt_fracdiff_list[ibin2].GetMaximum() * 2
                )
                hjetpt_fracdiff_list[ibin2].SetXTitle(
                    "(#it{p}_{T, jet}^{reco} #minus #it{p}_{T, jet}^{gen})/#it{p}_{T, jet}^{gen}"
                )
        ...
        leg_jetpt_fracdiff.Draw("same")
        cjetpt_fracdiff.SaveAs(
            "%s/cjetpt_fracdiff_prompt.eps" % (self.d_resultsallpdata)
        )

        creco_eff = TCanvas("creco_eff ", "reco efficiency applied to input data")
        preco_eff = TPad(
            "preco_eff", "reco efficiency applied to input data", 0.0, 0.001, 1.0, 1.0
        )
        setup_pad(preco_eff)
        creco_eff.SetCanvasSize(1900, 1500)
        creco_eff.SetWindowSize(500, 500)
        ...
        cz_fracdiff = TCanvas(
            "cz_fracdiff ", "prompt z response fractional differences"
        )
        pz_fracdiff = TPad(
            "pz_fracdiff",
            "prompt z response fractional differences",
            0.0,
            0.001,
            1.0,
            1.0,
        ...
        cz_fracdiff.SetCanvasSize(1900, 1500)
        cz_fracdiff.SetWindowSize(500, 500)
        leg_z_fracdiff = TLegend(0.2, 0.5, 0.5, 0.9, "z")
        setup_legend(leg_z_fracdiff)
        for ibinshape in range(self.p_nbinshape_gen):
            setup_histogram(hz_fracdiff_list[ibinshape], ibinshape + 1)
            leg_z_fracdiff.AddEntry(
            ...
            if ibinshape == 0:
                hz_fracdiff_list[ibinshape].GetYaxis().SetRangeUser(
                    0.001, hz_fracdiff_list[ibinshape].GetMaximum() * 2
                )
        ...
        for i in range(self.niter_unfolding):
            ...
            for ibin2 in range(self.p_nbin2_gen):
                ...
                unfolded_z = unfolded_zvsjetpt.ProjectionX(
                    "unfolded_z_" + suffix, ibin2 + 1, ibin2 + 1, "e"
                )
                unfolded_z.Sumw2()
                ...
                unfolded_z_scaled.Scale(
                    ...
                    / unfolded_z_scaled.Integral(
                        unfolded_z_scaled.FindBin(self.lvarshape_binmin_reco[0]),
                ...
                cunfolded_z = TCanvas(
                    "cunfolded_z" + suffix, "1D output of unfolding" + suffix
                )
                punfolded_z = TPad(
                    "punfolded_z" + suffix,
                ...
                unfolded_z_scaled.SetYTitle(
                    "1/#it{N}_{jets} d#it{N}/d#it{z}_{#parallel}^{ch}"
                )
                ...
                draw_latex(latex2)
                cunfolded_z.SaveAs(
                    "%s/cunfolded_z_%d_%s.eps" % (self.d_resultsallpdata, i + 1, suffix)
                )

            unfolded_jetpt = unfolded_zvsjetpt.ProjectionY(
                "unfolded_jetpt", 1, self.p_nbinshape_gen, "e"
            )
            ...
            punfolded_jetpt = TPad(
                "punfolded_jetpt", "1D output of unfolding", 0.0, 0.001, 1.0, 1.0
            )
            ...
            cunfolded_jetpt.SaveAs(
                "%s/cunfolded_jetpt_%d.eps" % (self.d_resultsallpdata, i + 1)
            )
            ...
            for ibin2 in range(self.p_nbin2_reco):
                ...
                cfolded_z = TCanvas(
                    "cfolded_z " + suffix, "1D output of folding" + suffix
                )
                pfolded_z = TPad(
                    "pfolded_z" + suffix,
                    "1D output of ufolding" + suffix,
                    0.0,
                    0.001,
                    1.0,
                    1.0,
                ...
                draw_latex(latex2)
                cfolded_z.SaveAs(
                    "%s/cfolded_z_%d_%s.eps" % (self.d_resultsallpdata, i + 1, suffix)
                )
            ...
            pfolded_jetpt = TPad(
                "pfolded_jetpt", "1D output of folding", 0.0, 0.001, 1.0, 1.0
            )
            ...
            latex = TLatex(
                0.2,
                0.25,
                "%.2f < #it{z}_{#parallel}^{ch} < %.2f GeV/#it{c}"
            ...
            cfolded_jetpt.SaveAs(
                "%s/cfolded_jetpt_%d.eps" % (self.d_resultsallpdata, i + 1)
            )
        ...
        for ibin2 in range(self.p_nbin2_gen):
            ...
            for i in range(self.niter_unfolding):
                ...
                if i == 0:
                    ...
                    unfolded_z_scaled_list[i][ibin2].GetYaxis().SetRangeUser(
                        0, unfolded_z_scaled_list[i][ibin2].GetMaximum() * 2.0
                    )
                    unfolded_z_scaled_list[i][ibin2].SetXTitle(
                        "#it{z}_{#parallel}^{ch}"
                    )
                ...
                cconvergence_z.SaveAs(
                    "%s/convergence_z_%s.eps" % (self.d_resultsallpdata, suffix)
                )

            cinput_mc_gen_z = TCanvas("cinput_mc_gen_z " + suffix, "1D gen pythia z")
            pinput_mc_gen_z = TPad(
                "pinput_mc_gen_z" + suffix,
                "1D gen pythia z" + suffix,
                0.0,
                0.001,
                1.0,
                1.0,
            ...
            leg_input_mc_gen_z = TLegend(0.2, 0.73, 0.45, 0.88, "")
            ...
            input_mc_gen_z[ibin2].GetYaxis().SetRangeUser(
                0.0, input_mc_gen_z[ibin2].GetMaximum() * 2
            )
            ...
            setup_histogram(
                unfolded_z_scaled_list[self.choice_iter_unfolding][ibin2], 2
            )
            leg_input_mc_gen_z.AddEntry(
                unfolded_z_scaled_list[self.choice_iter_unfolding][ibin2],
                "unfolded ALICE data",
                "LEP",
            )
            ...
            leg_input_mc_gen_z.AddEntry(
                input_powheg_z[ibin2], "POWHEG + PYTHIA 6", "LEP"
            )
            ...
            cinput_mc_gen_z.SaveAs(
                "%s/cinput_mc_gen_z_%s.eps" % (self.d_resultsallpdata, suffix)
            )
            cinput_mc_gen_z.SaveAs(
                "%s/cinput_mc_gen_z_%s.pdf" % (self.d_resultsallpdata, suffix)
            )

            cinput_mc_gen_z_xsection = TCanvas(
                "cinput_mc_gen_z_xsection " + suffix, "1D gen pythia z xsection"
            )
            pinput_mc_gen_z_xsection = TPad(
                "pinput_mc_gen_z_xsection" + suffix,
                "1D gen pythia z xsection" + suffix,
                0.0,
                0.001,
                1.0,
                1.0,
            ...
            leg_input_mc_gen_z_xsection = TLegend(0.2, 0.73, 0.45, 0.88, "")
            setup_legend(leg_input_mc_gen_z_xsection)
            setup_histogram(
                unfolded_z_xsection_list[self.choice_iter_unfolding][ibin2], 4
            )
            leg_input_mc_gen_z_xsection.AddEntry(
                unfolded_z_xsection_list[self.choice_iter_unfolding][ibin2],
                "unfolded ALICE data",
                "LEP",
            )
            unfolded_z_xsection_list[self.choice_iter_unfolding][
                ibin2
            ...
            unfolded_z_xsection_list[self.choice_iter_unfolding][
                ...
                0.0,
                unfolded_z_xsection_list[self.choice_iter_unfolding][ibin2].GetMaximum()
                * 2,
            )
            unfolded_z_xsection_list[self.choice_iter_unfolding][ibin2].SetXTitle(
                "#it{z}_{#parallel}^{ch}"
            )
            unfolded_z_xsection_list[self.choice_iter_unfolding][ibin2].SetYTitle(
                "xsection d#it{N}/d#it{z}_{#parallel}^{ch}"
            )
            unfolded_z_xsection_list[self.choice_iter_unfolding][ibin2].Draw()
            setup_histogram(input_powheg_xsection_z[ibin2], 3)
            leg_input_mc_gen_z_xsection.AddEntry(
                input_powheg_xsection_z[ibin2], "POWHEG + PYTHIA 6", "LEP"
            )
            ...
            cinput_mc_gen_z_xsection.SaveAs(
                "%s/cinput_mc_gen_z_xsection_%s.eps" % (self.d_resultsallpdata, suffix)
            )
            cinput_mc_gen_z_xsection.SaveAs(
                "%s/cinput_mc_gen_z_xsection_%s.pdf" % (self.d_resultsallpdata, suffix)
            )
        ...
        for ibin2 in range(self.p_nbin2_reco):
            ...
            pconvergence_refolding_z = TPad(
                "pconvergence_refolding_z" + suffix,
                "1D output of refolding convergence" + suffix,
                0.0,
                0.001,
                1.0,
            ...
            cconvergence_refolding_z.SaveAs(
                "%s/convergence_refolding_z_%s.eps" % (self.d_resultsallpdata, suffix)
            )
            ...
            input_data_z_scaled.Scale(
                1.0 / input_data_z_scaled.Integral(1, -1), "width"
            )
            cunfolded_not_z = TCanvas(
                "cunfolded_not_z " + suffix, "Unfolded vs not Unfolded" + suffix
            )
            punfolded_not_z = TPad(
                "punfolded_not_z" + suffix,
                "Unfolded vs not Unfolded" + suffix,
                0.0,
                0.001,
                1.0,
                1.0,
            ...
            leg_cunfolded_not_z = TLegend(0.15, 0.75, 0.35, 0.9, "")
            setup_legend(leg_cunfolded_not_z)
            setup_histogram(
                unfolded_z_scaled_list[self.choice_iter_unfolding][
            ...
            leg_cunfolded_not_z.AddEntry(
                input_data_z_scaled, "Side-Band sub, Eff Corrected", "LEP"
            )
            ...
            cunfolded_not_z.SaveAs(
                "%s/cunfolded_not_z_%s.eps" % (self.d_resultsallpdata, suffix)
            )
            ...
            for ibinshape in range(self.p_nbinshape_reco):
                error_on_unfolded = unfolded_z_scaled_list[self.choice_iter_unfolding][
                    input_mc_gen.GetYaxis().FindBin(self.lvar2_binmin_reco[ibin2]) - 1
                ].GetBinError(
                ...
                content_on_unfolded = unfolded_z_scaled_list[
            ...
            punfolded_not_stat_error = TPad(
                "punfolded_not_stat_error" + suffix,
                "Ratio of stat error after to before unfolding" + suffix,
                0.0,
                0.001,
                1.0,
            ...
            h_unfolded_not_stat_error.GetYaxis().SetRangeUser(
                0.0, h_unfolded_not_stat_error.GetMaximum() * 1.6
            )
            ...
            cunfolded_not_stat_error.SaveAs(
                "%s/unfolded_not_stat_error_%s.eps" % (self.d_resultsallpdata, suffix)
            )

        cconvergence_jetpt = TCanvas("cconvergence_jetpt ", "1D output of convergence")
        pconvergence_jetpt = TPad(
            "pconvergence_jetpt", "1D output of convergence", 0.0, 0.001, 1.0, 1.0
        )
        setup_pad(pconvergence_jetpt)
        cconvergence_jetpt.SetCanvasSize(1900, 1500)
        cconvergence_jetpt.SetWindowSize(500, 500)
        leg_jetpt = TLegend(0.7, 0.5, 0.85, 0.9, "iterations")
        ...
        pconvergence_refolding_jetpt = TPad(
            "pconvergence_refolding_jetpt",
            "1D output of refolding convergence",
            0.0,
            0.001,
            1.0,
            1.0,
        ...
        cconvergence_refolding_jetpt.SaveAs(
            "%s/convergence_refolding_jetpt.eps" % (self.d_resultsallpdata)
        )

    def unfolding_closure(self):
        lfile = TFile.Open(self.n_filemass, "update")
        fileouts = TFile.Open(
            "%s/unfolding_closure_results%s%s.root"
            % (self.d_resultsallpdata, self.case, self.typean),
            "recreate",
        )
        unfolding_input_file = TFile.Open(self.n_fileff)
        ...
        for i in range(self.niter_unfolding):
            ...
            for ibin2 in range(self.p_nbin2_gen):
                ...
                cclosure_z = TCanvas(
                    "cclosure_z " + suffix, "1D output of closure" + suffix
                )
                pclosure_z = TPad(
                    "pclosure_z" + suffix,
                ...
                draw_latex(latex2)
                cclosure_z.SaveAs(
                    "%s/cclosure_z_%d_%s.eps" % (self.d_resultsallpdata, i + 1, suffix)
                )
            ...
            pclosure_jetpt = TPad(
                "pclosure_jetpt", "1D output of closure", 0.0, 0.001, 1.0, 1.0
            )
            ...
            cclosure_jetpt.SaveAs(
                "%s/cclosure_jetpt_%d.eps" % (self.d_resultsallpdata, i + 1)
            )
        ...
        for ibin2 in range(self.p_nbin2_gen):
            ...
            pconvergence_closure_z = TPad(
                "pconvergence_closure_z" + suffix,
                "1D output of closure convergence" + suffix,
                0.0,
                0.001,
                1.0,
            ...
            cconvergence_closure_z.SaveAs(
                "%s/convergence_closure_z_%s.eps" % (self.d_resultsallpdata, suffix)
            )

        cconvergence_closure_jetpt = TCanvas(
            "cconvergence_closure_jetpt ", "1D output of closure convergence"
        )
        pconvergence_closure_jetpt = TPad(
            "pconvergence_closure_jetpt",
            "1D output of closure convergence",
            0.0,
            0.001,
            1.0,
            1.0,
        ...
        cconvergence_closure_jetpt.SaveAs(
            "%s/convergence_closure_jetpt.eps" % (self.d_resultsallpdata)
        )

    def jetsystematics(self):

        input_file_default = TFile.Open(
            "%s/unfolding_results%s%s.root"
            % (self.d_resultsallpdata, self.case, self.typean),
            "update",
        )
        ...
        for ibin2 in range(self.p_nbin2_gen):
            ...
            input_histograms_default.append(
                input_file_default.Get(
                    "unfolded_z_%d_%s" % (self.choice_iter_unfolding, suffix)
                )
            )
        ...
        for sys_cat in range(len(self.systematic_categories)):
            ...
            for sys_var in range(self.systematic_variations[sys_cat]):
                input_files_sysvar.append(
                    TFile.Open(
                        "/data/DerivedResultsJets/LckINT7HighMultwithJets/vAN-20190909_ROOT6-1/systematics/%s/sys_%d/pp_data/resultsMBjetvspt/unfolding_resultsLcpK0sppMBjetvspt.root"
                        % (self.systematic_categories[sys_cat], sys_var + 1),
                        "update",
                    )
                )
                    ...
                    if self.systematic_categories[sys_cat] == "regularisation":
                        if sys_var == 0:
                            input_histograms_syscatvar.append(
                                input_file_default.Get(
                                    "unfolded_z_%d_%s"
                                    % (self.niterunfoldingregdown, suffix)
                                )
                            )
                        else:
                            input_histograms_syscatvar.append(
                                input_file_default.Get(
                                    "unfolded_z_%d_%s"
                                    % (self.niterunfoldingregup, suffix)
                                )
                            )
                    else:
                        input_histograms_syscatvar.append(
                            input_files_sys[sys_cat][sys_var].Get(
                                "unfolded_z_%d_%s"
                                % (self.choice_iter_unfolding, suffix)
                            )
                        )
        ...
        for ibin2 in range(self.p_nbin2_gen):
            ...
            leg_sysvar = TLegend(0.7, 0.5, 0.85, 0.9, "systematics")
            ...
            input_histograms_default[ibin2].GetYaxis().SetRangeUser(
                0.0, input_histograms_default[ibin2].GetMaximum() * 1.5
            )
            ...
            for sys_cat in range(len(self.systematic_categories)):
                for sys_var in range(self.systematic_variations[sys_cat]):
                    ...
                    leg_sysvar.AddEntry(
                        ...
                        ("%s_%d" % (self.systematic_categories[sys_cat], sys_var + 1)),
                        "LEP",
                    )
                    setup_histogram(
                        input_histograms_sys[ibin2][sys_cat][sys_var], nsys + 1
                    )
            ...
            for sys_cat in range(len(self.systematic_categories)):
                ...
                csysvar_each = TCanvas(
                    "csysvar " + suffix2 + suffix,
                    "systematic variations" + suffix2 + suffix,
                )
                psysvar_each = TPad(
                    "psysvar" + suffix2 + suffix,
                    "systematic variations" + suffix2 + suffix,
                    0.0,
                    0.001,
                    1.0,
                ...
                leg_sysvar_each = TLegend(
                    0.7, 0.45, 0.85, 0.85, self.systematic_categories[sys_cat]
                )
                setup_legend(leg_sysvar_each)
                leg_sysvar_each.AddEntry(
                    input_histograms_default[ibin2], "default", "LEP"
                )
                setup_histogram(input_histograms_default[ibin2], 1)
                for sys_var in range(self.systematic_variations[sys_cat]):
                    if sys_var == 0:
                        if sys_cat == 0:
                            input_histograms_default[ibin2].GetYaxis().SetRangeUser(
                                0.0, input_histograms_default[ibin2].GetMaximum() * 2.5
                            )
                        input_histograms_default[ibin2].GetXaxis().SetRangeUser(
                            self.lvarshape_binmin_gen[0] + 0.01,
                            self.lvarshape_binmax_gen[-1] - 0.001,
                        )
                        input_histograms_default[ibin2].SetXTitle(
                            "#it{z}_{#parallel}^{ch}"
                        )
                        input_histograms_default[ibin2].SetYTitle(
                            "1/#it{N}_{jets} d#it{N}/d#it{z}_{#parallel}^{ch}"
                ...
                csysvar_each.SaveAs(
                    "%s/ysvar%s_%s.eps" % (self.d_resultsallpdata, suffix2, suffix)
                )
                ...
                for sys_cat in range(len(self.systematic_categories)):
                    ...
                    for sys_var in range(self.systematic_variations[sys_cat]):
                        error = input_histograms_sys[ibin2][sys_cat][
                            sys_var
                        ].GetBinContent(ibinshape + 1) - input_histograms_default[
                            ibin2
                        ].GetBinContent(
                            ibinshape + 1
                        )
        ...
        for i_pythia8 in range(len(self.pythia8_prompt_variations)):
            ...
            input_pythia8.append(
                input_pythia8_file[i_pythia8].Get("fh2_pythia8_prompt")
            )
            input_pythia8_xsection.append(
                input_pythia8_file[i_pythia8].Get("fh2_pythia8_prompt_xsection")
            )
            ...
            for ibin2 in range(self.p_nbin2_gen):
                ...
                input_pythia8_z_jetpt[ibin2].Scale(
                    1.0 / input_pythia8_z_jetpt[ibin2].Integral(1, -1), "width"
                )
        ...
        for ibin2 in range(self.p_nbin2_gen):
            ...
            cfinalwsys = TCanvas(
                "cfinalwsys " + suffix, "final result with systematic errors" + suffix
            )
            pfinalwsys = TPad(
                "pfinalwsys" + suffix,
                "final result with systematic errors" + suffix,
                0.0,
                0.001,
                1.0,
                1.0,
            ...
            leg_finalwsys = TLegend(0.65, 0.6, 0.85, 0.7, "")
            ...
            input_histograms_default[ibin2].GetYaxis().SetRangeUser(
                0.0, input_histograms_default[ibin2].GetMaximum() * 1.2 / 2.5
            )
            input_histograms_default[ibin2].GetXaxis().SetRangeUser(
                self.lvarshape_binmin_gen[0] + 0.01,
                self.lvarshape_binmax_gen[-1] - 0.001,
            ...
            latex1 = TLatex(
                0.18,
                0.8,
                "#Lambda_{c}^{#plus} (& cc) in charged jets, anti-#it{k}_{T}, #it{R} = 0.4, #left|#it{#eta}_{jet}#right| < 0.5",
            )
            draw_latex(latex1)
            latex2 = TLatex(
                0.18,
            ...
            latex3 = TLatex(
                0.18,
                0.7,
                "%.0f < #it{p}_{T, #Lambda_{c}^{#plus}} < %.0f GeV/#it{c}"
                % (self.lpt_finbinmin[0], self.lpt_finbinmax[-1]),
            )
            draw_latex(latex3)
            ...
            cfinalwsys_wmodels = TCanvas(
                ...
                "final result with systematic errors with models" + suffix,
            )
            pfinalwsys_wmodels = TPad(
                "pfinalwsys_wmodels" + suffix,
                "final result with systematic errors with models" + suffix,
                0.0,
                0.001,
                1.0,
            ...
            leg_finalwsys_wmodels = TLegend(0.55, 0.55, 0.65, 0.75, "")
            setup_legend(leg_finalwsys_wmodels)
            leg_finalwsys_wmodels.AddEntry(
                input_histograms_default[ibin2], "data", "LEP"
            )
            setup_histogram(input_histograms_default[ibin2], 4)
            input_histograms_default[ibin2].GetYaxis().SetRangeUser(
                0.0, input_histograms_default[ibin2].GetMaximum()
            )
            input_histograms_default[ibin2].GetXaxis().SetRangeUser(
                self.lvarshape_binmin_gen[0] + 0.01,
                self.lvarshape_binmax_gen[-1] - 0.001,
            ...
            leg_finalwsys_wmodels.AddEntry(
                input_powheg_z[ibin2], "POWHEG #plus PYTHIA 6", "LEP"
            )
            input_powheg_z[ibin2].Draw("same")
            ...
            cfinalwsys_wmodels.SaveAs(
                "%s/finalwsys_wmodels_%s.pdf" % (self.d_resultsallpdata, suffix)
            )

            crelativesys = TCanvas(
                "crelativesys " + suffix, "relative systematic errors" + suffix
            )
            prelativesys = TPad(
                "prelativesys" + suffix,
                "relative systematic errors" + suffix,
                0.0,
                0.001,
                1.0,
                1.0,
            ...
            leg_relativesys = TLegend(0.7, 0.5, 0.85, 0.9, "")
            ...
            for sys_cat in range(len(self.systematic_categories)):
                ...
                tgsys_cat[ibin2][sys_cat].GetXaxis().SetRangeUser(
                    self.lvarshape_binmin_gen[0] + 0.01,
                    self.lvarshape_binmax_gen[-1] - 0.001,
                )
                ...
                leg_relativesys.AddEntry(
                    tgsys_cat[ibin2][sys_cat],
                    self.systematic_categories[sys_cat],
                    "LEP",
                )
                if sys_cat == 0:
            ...
            crelativesys.SaveAs(
                "%s/relativesys_%s.pdf" % (self.d_resultsallpdata, suffix)
            )

        file_feeddown = TFile.Open(
            "%s/feeddown%s%s.root" % (self.d_resultsallpdata, self.case, self.typean)
        )
        file_feeddown_variations = []
        for i_powheg in range(len(self.powheg_nonprompt_variations)):
            file_feeddown_variations.append(
                TFile.Open(
                    "/data/DerivedResultsJets/LckINT7HighMultwithJets/vAN-20190909_ROOT6-1/systematics/powheg/sys_%d/pp_data/resultsMBjetvspt/feeddown%s%s.root"
                    % (i_powheg + 1, self.case, self.typean),
                    "update",
                )
            )
        h_feeddown_fraction = []
        ...
        for ibin2 in range(self.p_nbin2_reco):
            ...
            h_feeddown_fraction[ibin2].GetYaxis().SetTitle(
                "#Lambda_{b} feed-down fraction"
            )
            ...
            #            draw_latex(latex7)
            cfeeddown_fraction.SaveAs(
                "%s/feeddown_fraction_werros_%s.pdf" % (self.d_resultsallpdata, suffix)
            )
