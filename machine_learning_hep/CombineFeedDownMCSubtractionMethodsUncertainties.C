  ...
  Int_t decay = 6)
{
  ...
  leg->SetTextFont(42);
  if (decay == 1)
    leg->AddEntry(thD0KpifromBprediction, "FONLL ", "fl");
  else if (decay == 2)
    leg->AddEntry(thDpluskpipiprediction, "FONLL ", "fl");
  else if (decay == 3)
    leg->AddEntry(thDstarD0piprediction, "FONLL ", "fl");
  else if (decay == 4)
    leg->AddEntry(thDsKKpiprediction, "FONLL ", "fl");
  else if (decay == 6)
    leg->AddEntry(thLcpK0Sprediction, "FONLL ", "fl");
